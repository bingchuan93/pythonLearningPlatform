...
export const xlsToArray = (data) => {
    //Fetch the name of First Sheet.
    var firstSheet = data.SheetNames[0];

    //Read all rows from First Sheet into an JSON array.
    var excelRows = XLSX.utils.sheet_to_row_object_array(data.Sheets[firstSheet]);
    // var excelRows = XLSX.utils.sheet_to_json(data.Sheets[firstSheet], {header: 1, raw: true});
    ...
    // for (var i = 7; i < excelRows.length; i++) {
